...
const UpdateCard = () => {
    ...
    useEffect(() => {
        axios.post("http://localhost:3001/getUpdateDataCard", {id})
            .then(res => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        try {
            axios.post("http://localhost:3001/UpdateCard", {id,pnumber,pname,buyingprice,bought,amountout,sellingprice,sold,stock,unitprofit,profit})
                .then((response) => {
